...
def test_0_ks_ex1():
    ...
    print("0_ks_ex2 optimization optimal value: {:}".format('/'.join([str(calculated_value) for calculated_value in calculated_values])))
...
def test_1_ks_ex1():
    ...
    # assert np.abs(0.17-calculated_values[0])<1e-6
    assert np.all(np.diff(np.array(calculated_values))<0)
    print("1_ks_ex1 optimization optimal value: {:}".format('/'.join([str(calculated_value) for calculated_value in calculated_values])))
...
def test_2_ks_ex1():
    ...
    # assert np.abs(0.17-calculated_values[0])<1e-6
    assert np.all(np.diff(np.array(calculated_values))<0)
    print("2_ks_ex1 optimization optimal value: {:}".format('/'.join([str(calculated_value) for calculated_value in calculated_values])))
...
def test_0_chi2_ex1():
    ...
    print("0_chi2_ex1 optimization optimal value: {:}".format('/'.join([str(calculated_value) for calculated_value in calculated_values[::-1]])))
